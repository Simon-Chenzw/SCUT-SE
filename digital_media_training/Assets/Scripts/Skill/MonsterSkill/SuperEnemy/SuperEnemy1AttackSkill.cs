...
[CreateAssetMenu(
    fileName = "SuperEnemy1AttackSkill",
    menuName = "Skill/Enemy/SuperEnemy1AttackSkill"
)]
public class SuperEnemy1AttackSkill : MonsterSkill
{
    public override string SkillName
    {
        get { return "SuperEnemy1AttackSkill"; }
    }
    ...
    public override void CreateSkill(Bounds bounds, Transform transform)
    {
        ...
        GameObject SkillObject = Resources.Load<GameObject>("SkillRange/SuperEnemy1AttackSkill");
